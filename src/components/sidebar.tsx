...
const navItems = [
  ...
  },
  {
    ...
    filledIcon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
    roles: ['owner', 'admin'] as UserRole[],
    mobileOrder: 4,
  },
  {
    label: 'Failure Reasons',
    href: '/failure-reasons',
    ...
    filledIcon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4.5c-.77-.833-2.694-.833-3.464 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z',
    roles: ['owner', 'admin'] as UserRole[],
    mobileOrder: 5,
  },
  {
